...
# 安装指定版本的包
pip install -r requirements/mech_requirement.txt

cd machine_learning
python feature_engineering/face.py --model train --xlsx ../dataset/train.xlsx --out_csv output/train_face.csv
python feature_engineering/face.py --model test --xlsx ../dataset/test.xlsx --out_csv output/test_face.csv