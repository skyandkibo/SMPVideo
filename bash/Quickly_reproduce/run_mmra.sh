...
cd MMRA
python test.py --dataset_model train_test --input_dir ./datasets/tiktok/final_easy_excel --model_path train_results/train_MMRA_tiktok_MSE/trained_model/model_12.pth